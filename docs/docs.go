...
// 2019-09-13 15:22:46.6514287 +0500 +05 m=+0.109970501
...
var doc = `{
    ...
    "paths": {
        ...
        "/subscription/my/extend": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Запрос на продление",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/model.ValidateSubscriptionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.ValidateSubscriptionRequest": {
            "type": "object",
            "required": [
                "receipt_data"
            ],
